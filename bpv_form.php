<form class="form-bpv">
        ...
        <input type="text" id="nameCompany" class="form-control" 
               placeholder="Naam van het bedrijf" required autofocus >

        <label for="phoneNumberCompany" class="sr-only">Telefoonnr. vast</label>
        <input type="text" id="phoneNumberCompany" class="form-control" 
               placeholder="Telefoonnr vast" required autofocus >


        <label for="nameContact" class="sr-only">Naam contact</label>
        <input type="text" id="nameContact" class="form-control" 
               placeholder="Naam contact" required autofocus >

        <label for="mobileContact" class="sr-only">06-nr. contact</label>
        <input type="text" id="mobileContact" class="form-control" 
               placeholder="06-nr. contact" required autofocus >

        
        <label for="streetName" class="sr-only">Straatnaam</label>
        <input type="text" id="streetName" class="form-control" placeholder="Straatnaam" required>

        <label for="houseNumber" class="sr-only">huisnummer</label>
        <input type="text" id="houseNumber" class="form-control" placeholder="Huisnummer" required>
        
        <label for="postcode" class="sr-only">Postcode</label>
        <input type="text" id="postalcode" class="form-control" placeholder="Postcode" required>
        
        <label for="city" class="sr-only">Woonplaats</label>
        <input type="text" id="city" class="form-control" placeholder="Woonplaats" required>
        
        
        <label for="urlCompany" class="sr-only">URL website BPVbedrijf</label>
        <input type="url" id="urlCompany" class="form-control" placeholder="URL website BPV bedrijf" required>
        
        
        <label for="emailContact" class="sr-only">E-mail contactpersoon</label>
        
        <input type="email" id="emailContact" class="form-control" placeholder="E-mailadres contactpersoon" required>
        
        <label for="whatToDo" class="sr-only">Korte omschrijving</label>
        <textarea id="whatToDo" class="form-control" placeholder="Korte omschrijving verwachte werkzaamheden" required></textarea>
        
        <label for="dateTime" class="sr-only">Datum Tijd</label>
        <input type="hidden" id="dateTime" class="form-control" placeholder="<?php echo date('Y-m-d H:i:s') ?>" required>
